...
""")
st.caption("_\* 'Connect': the driver doesn’t meet the owner and opens the car with his smartphone_   _\* '📱 Mobile': rental agreement on native apps: driver and owner meet and both sign the rental agreement on the owner’s smartphone")
